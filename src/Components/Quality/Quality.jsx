  ...
  return (
    <section className="quality">
      ...
      <div className="container">
        <div className="row">
          <div className="quality--left_side col-xl-6">
            <div className="quality--photo"></div>
          </div>
          <div className="quality--right_side col-xl-6">
              ...
              <div className="quality--list_content">
                ...
                <div className="quality--list_details">
                  <p>
                    ...
                    and deliver the superior build quality associated with the
                    CMH Guards name.
                  </p>
                </div>
              </div>
